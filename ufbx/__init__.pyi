...
class BakedNode:
    ...
    @property
    def translation_times(self) -> np.ndarray[Any, Any]: ...
    @property
    def translation_values(self) -> np.ndarray[Any, Any]: ...
    @property
    def rotation_times(self) -> np.ndarray[Any, Any]: ...
    @property
    def rotation_values(self) -> np.ndarray[Any, Any]: ...
    @property
    def scale_times(self) -> np.ndarray[Any, Any]: ...
    @property
    def scale_values(self) -> np.ndarray[Any, Any]: ...
...
class Scene:
    ...
    def anim(self) -> Anim | None: ...
    def bake_anim(
        self, anim: Anim | None = None, resample_rate: float = 30.0, trim_start_time: bool = False
    ) -> BakedAnim: ...
    @property
    def axes(self) -> CoordinateAxes: ...
...
class Node(Element):
    ...
    @property
    def typed_id(self) -> int: ...
    def evaluate_transform(self, time: float, anim: Anim | None = None) -> Transform: ...
    @property
...
def load_file(filename: str, ignore_geometry: bool = False, ignore_embedded: bool = False) -> Scene: ...
